            ...
            <>
              ...
              <div className="product-info col-sm-12 col-md-6 mt-md-3 m-auto row">
                <div className="col col-md-6 col-12">
                  ...
                  <p className="desc">
                    {tempProduct.desc} تكتيك على الاختيار بين المنتجات
                    والمستلزمات الرياضية من خلال تقديم خدمة ما تكتيك على
                    الاختيار بين المنتجات والمستلزمات الرياضية من خلال تقديم
                    خدمة ما
                  </p>
                </div>
